...
export default {
  async fetch(request, env) {
    ...
    for (const key of ['id', 'room', 'sender', 'type', 'userId', 'to', 'from', 'alias']) {
...
// ============================================================
// ============================================================
// WEB PUSH — store subscriptions, send notifications
//
// Requires VAPID keys:
...
async function sendPushToUser(userId, payload, env) {
  ...
  for (const sub of subs) {
    try {
      // Web Push with VAPID — requires crypto signing
      // Use Cloudflare Workers compatible Web Push
